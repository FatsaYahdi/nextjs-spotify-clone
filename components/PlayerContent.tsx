    ...
    return ( 
        <div className="grid grid-cols-2 md:grid-cols-3 h-full">
            ...
            <div className="flex md:hidden col-auto w-full justify-end items-center">
                <div className="h-10 w-10 flex items-center justify-center bg-white rounded-full p-1 cursor-pointer" onClick={handlePlay}>
                    <Icon size={30} className="text-black" />
                </div>
            </div>
            <div className="hidden md:flex h-full w-full items-center justify-center max-w-[722px] gap-x-6">
